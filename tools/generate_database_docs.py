...
FIELD_DESCRIPTIONS = {
    ...
    "expected_translator_stats_method": "预期译员计量方式",
    "expected_translator_word_count": "预期译员计费字数",
    ...
    "send_error": "最近发送错误",
    "dispatch_id": "所属派发批次",
    "planned_word_count": "计划派发字数",
    "actual_word_count": "实际确认字数",
