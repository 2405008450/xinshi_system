...
def test_manuscript_attachment_accepts_exactly_10mb_and_normalizes_name():
...
def test_manuscript_attachment_rejects_file_over_10mb():
    ...
    assert exc_info.value.detail == "上传文件不能超过 10MB"
