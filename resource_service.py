...
def get_talent_annotation_project_performance(
    ...
    return {
        ...
        "trials": [{
            ...
            "language_label": (
                db.get(AnnotationProjectLanguageItem, item.language_item_id).display
                if item.language_item_id else None
            ),
            "trial_status": item.trial_status, "trial_result": item.trial_result,
            "willingness_level": item.willingness_level,
            "willingness_text": item.willingness_text,
            ...
            "cooperation_note": item.cooperation_note,
            "punctuality_level": item.punctuality_level,
            "punctuality_note": item.punctuality_note,
