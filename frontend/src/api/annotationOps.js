...
export const getTrialCount = (projectId, params = {}, config = {}) => get('/annotation-ops/trials/count', { project_id: projectId || undefined, ...params }, config)
...
export const getTrialStrategies = (projectId) => get(`/annotation-ops/projects/${projectId}/trial-strategies`)
export const saveTrialStrategies = (projectId, items) => put(`/annotation-ops/projects/${projectId}/trial-strategies`, { items })
export const getTrialSummary = (projectId) => get(`/annotation-ops/projects/${projectId}/trial-summary`)
export const getTrialFollowUps = (trialId) => get(`/annotation-ops/trials/${trialId}/follow-ups`)
export const createTrialFollowUp = (trialId, data) => post(`/annotation-ops/trials/${trialId}/follow-ups`, data)
