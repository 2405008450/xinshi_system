...
export const getProjectFileCount = () => api.get('/project-files/count')
export const getProjectFilesByProject = (projectId, params) => 
  api.get(`/project-files/project/${projectId}`, { params })
export const getProjectFileCountByProject = (projectId) => api.get(`/project-files/project/${projectId}/count`)
