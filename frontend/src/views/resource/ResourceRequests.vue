...
const projectStatusLabels = {
  ...
  initial_follow_up: '初步跟进中', deal_pending_execution: '已成交待执行', in_progress: '进行中', ended: '已结束', settled: '已结款', active: '进行中', completed: '已完成', cancelled: '已取消',
