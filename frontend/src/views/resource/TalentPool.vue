      ...
      <div ref="editorBodyRef" class="talent-editor-body">
        ...
        <div class="form-section">
          <div class="form-section-header name-section-header">
            ...
            <el-button text type="primary" :aria-expanded="nameFieldsExpanded" @click="nameFieldsExpanded=!nameFieldsExpanded">{{ nameFieldsExpanded ? '收起姓名' : '展开姓名' }}</el-button>
          </div>
          <el-collapse-transition>
            <div v-show="nameFieldsExpanded">
              <el-row :gutter="16"><el-col :xs="24" :md="8"><el-form-item label="中文姓名" prop="nameGroup"><el-input v-model="form.chineseName" @input="validateNameGroupField" /></el-form-item></el-col><el-col :xs="24" :md="8"><el-form-item label="英文姓名"><el-input v-model="form.englishName" @input="validateNameGroupField" /></el-form-item></el-col><el-col :xs="24" :md="8"><el-form-item label="昵称"><el-input v-model="form.nickname" @input="validateNameGroupField" /></el-form-item></el-col></el-row>
              <el-row :gutter="16"><el-col :xs="24" :md="8"><el-form-item label="其他名字"><el-select v-model="form.otherNames" multiple filterable allow-create default-first-option style="width:100%" @change="validateNameGroupField" /></el-form-item></el-col></el-row>
            </div>
          </el-collapse-transition>
...
const displayTalentName = (talent, fallback = '-') => getTalentDisplayName(talent, fallback)
...
const {fieldSearchRef,fieldSearchKeyword,fetchFieldSuggestions,locateDialogField:locateDialogFieldBase,clearFieldSearch}=useDialogFieldSearch(editorBodyRef)
const locateDialogField=async item=>{if(['中文姓名','英文姓名','昵称','其他名字'].includes(item?.searchLabel))nameFieldsExpanded.value=true;await nextTick();return locateDialogFieldBase(item)}
