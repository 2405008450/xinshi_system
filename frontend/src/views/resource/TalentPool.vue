    ...
    <el-dialog v-model="editorVisible" width="min(980px, calc(100vw - 32px))" top="5vh" class="talent-editor-dialog" @closed="resetForm">
      ...
      <div ref="editorBodyRef" class="talent-editor-body">
        ...
        <div class="form-section"><h3>基础信息</h3>
          ...
          <el-row :gutter="16"><el-col :xs="24" :md="8"><el-form-item label="主要邮箱"><el-input v-model="form.primaryEmail" /></el-form-item></el-col><el-col :xs="24" :md="8"><el-form-item label="备用邮箱"><el-input v-model="form.secondaryEmail" /></el-form-item></el-col><el-col :xs="24" :md="8"><el-form-item label="首次联系时间"><el-date-picker v-model="form.firstContactDate" type="datetime" value-format="YYYY-MM-DDTHH:mm:ss" style="width:100%" /></el-form-item></el-col></el-row>
