    ...
    <el-dialog v-model="editorVisible" :title="editorTitle" width="min(980px, calc(100vw - 32px))" top="5vh" class="talent-editor-dialog" @closed="resetForm">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="105px">
        <div class="form-section"><h3>基础信息</h3>
          ...
          <el-row :gutter="16"><el-col :xs="24" :md="8"><el-form-item label="性别"><el-select v-model="form.gender" clearable filterable allow-create default-first-option style="width:100%"><el-option label="男" value="男" /><el-option label="女" value="女" /></el-select></el-form-item></el-col><el-col :xs="24" :md="8"><el-form-item label="出生日期"><el-date-picker v-model="form.birthDate" type="date" value-format="YYYY-MM-DD" style="width:100%" /></el-form-item></el-col><el-col :xs="24" :md="8"><el-form-item label="籍贯"><el-input v-model="form.nativePlace" placeholder="例如：福建泉州" /></el-form-item></el-col></el-row>
          <el-row :gutter="16"><el-col :xs="24" :md="12"><el-form-item label="现居地址"><el-input v-model="form.residenceAddress" placeholder="填写到市/区县即可" /></el-form-item></el-col><el-col :xs="24" :md="12"><el-form-item label="方言区域"><el-select v-model="form.dialectRegions" multiple filterable allow-create default-first-option style="width:100%" placeholder="例如：泉州石狮"><el-option v-for="item in form.dialectRegions" :key="item" :label="item" :value="item" /></el-select></el-form-item></el-col></el-row>
...
function fromDetail(d){const base=emptyForm();return {...base,...d,id:d.id,capabilityTypes:d.capabilityTypes||[],writtenProfile:{...base.writtenProfile,...(d.writtenProfile||{})},interpretationProfile:{...base.interpretationProfile,...(d.interpretationProfile||{})},annotationProfile:{...base.annotationProfile,...(d.annotationProfile||{})},annotationLanguageSkills:(d.annotationLanguageSkills||[]).map(item=>({sourceLanguageId:item.sourceLanguageId,targetLanguageId:item.targetLanguageId||null})),careerProfile:{...base.careerProfile,...(d.careerProfile||{})}}}
