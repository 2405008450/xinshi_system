  ...
  <el-card>
    <template #header>
      <div class="card-header">
        <span>笔译项目管理</span>
        <el-button type="primary" @click="handleAdd">新增笔译项目</el-button>
      </div>
    </template>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="字数" prop="word_count">
              <el-input-number v-model="form.word_count" :min="0" style="width: 100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
const handleAdd = () => {
  dialogTitle.value = '新增笔译项目'
  resetForm()
  dialogVisible.value = true
}

const handleEdit = (row) => {
  dialogTitle.value = '编辑笔译项目'
  Object.assign(form, {
    id: row.id,
