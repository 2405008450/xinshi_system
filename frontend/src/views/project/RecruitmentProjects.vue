  ...
  <el-card>
    <template #header>
      <div class="card-header">
        <span>招聘项目管理</span>
        <el-button type="primary" @click="handleAdd">新增招聘项目</el-button>
      </div>
    </template>
    ...
    >
      ...
      >
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="要求语种" prop="required_languages">
              <el-input v-model="form.required_languages" placeholder="例如：中英、中日" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="候选人数量" prop="candidate_count">
              <el-input-number v-model="form.candidate_count" :min="0" style="width: 100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
const handleAdd = () => {
  dialogTitle.value = '新增招聘项目'
  resetForm()
  dialogVisible.value = true
}

const handleEdit = (row) => {
  dialogTitle.value = '编辑招聘项目'
  Object.assign(form, {
    id: row.id,
