...
const subOrders = ref([])
const project = reactive({ id: '', orderNo: '', projectName: '', fileTypeSecondary: '', languagePair: '', priority: '', wordCount: 0, projectStatus: 'pending', customerDeadlineTime: '', sentToClientTime: '', clientFeedback: '', translatorId: '', translatorAssignmentTime: '', expectedTranslatorStatsMethod: '', expectedTranslatorWordCount: 0, translatorDeliveryProgress: '', preReviewQcProgress: '', review1Progress: '', review2Progress: '', postReviewQcProgress: '', layoutProgress: '', consolidationProgress: '', networkFilePath: '' })
const createSubOrderForm = () => ({ id: '', parentProjectId: projectId, subOrderNo: '', subProjectName: '', fileTypeSecondary: '', languagePair: '', priority: '', wordCount: 0, customerDeadlineTime: '', sentToClientTime: '', clientFeedback: '', translatorId: '', translatorAssignmentTime: '', expectedTranslatorStatsMethod: '', expectedTranslatorWordCount: 0, status: 'pending', translatorDeliveryProgress: '', preReviewQcProgress: '', review1Progress: '', review2Progress: '', postReviewQcProgress: '', layoutProgress: '', consolidationProgress: '', networkFilePath: '', remarks: '' })
...
const NULLABLE_FIELDS = ['subProjectName', 'fileTypeSecondary', 'languagePair', 'priority', 'customerDeadlineTime', 'sentToClientTime', 'clientFeedback', 'translatorId', 'translatorAssignmentTime', 'expectedTranslatorStatsMethod', 'expectedTranslatorWordCount', 'translatorDeliveryProgress', 'preReviewQcProgress', 'review1Progress', 'review2Progress', 'postReviewQcProgress', 'layoutProgress', 'consolidationProgress', 'networkFilePath', 'remarks']
const subOrderDetailItems = [
  { label: 'ID', key: 'id', span: 2 }, { label: '母订单ID', key: 'parentProjectId', span: 2 }, { label: '子订单号', key: 'subOrderNo' }, { label: '子项目名称', key: 'subProjectName' },
  { label: '状态', key: 'status', type: 'status' }, { label: '文件二级类型', key: 'fileTypeSecondary' }, { label: '语言对', key: 'languagePair' }, { label: '优先级', key: 'priority' },
  { label: '字数', key: 'wordCount' }, { label: '客户交稿时间', key: 'customerDeadlineTime' }, { label: '发客户时间', key: 'sentToClientTime' }, { label: '客户反馈', key: 'clientFeedback', span: 2 },
  { label: '译员ID', key: 'translatorId' }, { label: '译员分配时间', key: 'translatorAssignmentTime' }, { label: '预计统计方式', key: 'expectedTranslatorStatsMethod' }, { label: '预计译员字数', key: 'expectedTranslatorWordCount' },
